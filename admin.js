...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Normal admin işlemlerine devam et
    initializeStorage();
    setupEventListeners();
    loadFormsTab();
});
...
function checkLogin() {
    ...
    // 24 saat sonra otomatik çıkış kontrolü
    ...
    console.log('Giriş başarılı, admin panele erişim veriliyor...');
    return true;
}
...
// Çıkış butonu ekle (opsiyonel - admin panelinde çıkış butonu istersen)
...
// Sayfa yüklendikten sonra çıkış butonunu ekle
